...
export function SectionFrame({
  ...
  return (
    ...
    >
      <div
        data-stack-card
        className={`relative w-[96%] max-w-[1760px] mx-auto lg:min-h-[80vh] flex flex-col justify-center overflow-hidden rounded-[2rem] md:rounded-[3rem] shadow-2xl ring-1 ring-[#147BFE]/15 origin-top will-change-transform transition-[transform,filter,box-shadow] duration-500 ease-out ${cardClassName}`}
      >
